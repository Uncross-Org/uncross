...
- **The community auction, 24 September.** Announced ahead of time, it ran on the regular AAPLx and IBMx books around 12:30–13:00 UTC. 11 wallets other than the test bot's placed orders, and every one of them got a fill. Nine were new wallets funded through the app's "Get test tokens" in the fifteen minutes before the books closed; the other two had taken part in the 23 September cross. We do not know who controls the nine. The bot was not held out: three of its test wallets placed an order in each book, and they account for about 5% of AAPLx's filled shares and 9% of IBMx's.
  - **AAPLx.** 24 orders from 13 wallets, 10 of them not the bot. Cleared 53.16 shares at $336.97. Auction `7uc3uXqHFRx5eqAbuDV5BUdoimCVYLARQYDCYYMivcVn`, cross `439jNtYvUnqosHwJpcgXarVmxSMixB11X43omAsq22pEtGJ8T971Jz6hHjKksnpSvcR7AwBYxwase2J8wqCHk2wC`.
  - **IBMx.** 20 orders from 12 wallets, 9 of them not the bot. Cleared 28.97 shares at $207.27 a share. Auction `JgkL8nLKuFA2rGRCjmFy2EC75mxpZXsXYumWBe6WnwD`, cross `2MvdyHfbfVtnJ578cTWs1ZW9VXYUEHMxKNL7VLmzqc3Fd17kKiYqE1fNmfcDSQGrRgHNKXRDcg3LXkNxymrSCk1K`.
