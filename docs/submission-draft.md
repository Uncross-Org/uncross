...
**Final text, 25 Sept 2026.** Paste two sections: "Short description" into the
...
- **The community auction, 24 September: 11 wallets besides our test bot.** It was announced publicly ahead of time and run on devnet, on the regular AAPLx and IBMx books, which crossed at 13:02 and 12:58 UTC. 44 orders were placed across the two books: 38 by 11 wallets besides our test bot, and 6 by the bot itself. The bot had three wallets in each book, and they account for 4.7% of AAPLx's filled shares and 9.1% of IBMx's. All 11 wallets got a fill, and no order was cancelled. 8 of them traded in both books. 9 of the 11 first appeared on chain between 12:47 and 12:59 UTC, in the 15 minutes before the AAPLx cross; the other two had taken part in the 23 September cross. We do not know who controls the nine.
  - **AAPLx.** 24 orders from 13 wallets, 10 of them not the bot's. Cleared **53.16 shares at $336.97**: 16 orders filled in full, 3 in part, 5 not at all. Auction: https://explorer.solana.com/address/7uc3uXqHFRx5eqAbuDV5BUdoimCVYLARQYDCYYMivcVn?cluster=devnet. Cross: `439jNtYvUnqosHwJpcgXarVmxSMixB11X43omAsq22pEtGJ8T971Jz6hHjKksnpSvcR7AwBYxwase2J8wqCHk2wC`. Settlements: `3GVouS2VuyK4pYWRUGv6nX147uKjBcSEcy5os9AU9Ti2veBgadRSKcNob2JyqL5m4o9b9aQEw3GmwtQ4N9Bv9ckH`, `44yyhpbtEMVzZueTxhZe8teC5bkaQsEqabMtENxLSV1cue8ycA2NrhuZhaxVNVZwSgkgLR4Rc69i797HJwDgfXc8`, `3X5M32Ea33bM7cjUVsPWfdNERq8r7PMcJgxdUMK1PbCSPMTsrH3M34Duw1rEXjUCxj4uE5ejqpSQskUt7irP2hJY`, `BWTFG3M8qdGgWcLr4xLm3YdDL9vjSp9FANaVDuR1R1sgBC6h7gWHN65P7VKMt1ZotkiowLj25asMeCc4tB7Go2P`.
  - **IBMx.** 20 orders from 12 wallets, 9 of them not the bot's. Cleared **28.97 shares at $207.27 a share**: 11 orders filled in full, 7 in part, 2 not at all. There is no Pyth price for IBM on Solana. Auction: https://explorer.solana.com/address/JgkL8nLKuFA2rGRCjmFy2EC75mxpZXsXYumWBe6WnwD?cluster=devnet. Cross: `2MvdyHfbfVtnJ578cTWs1ZW9VXYUEHMxKNL7VLmzqc3Fd17kKiYqE1fNmfcDSQGrRgHNKXRDcg3LXkNxymrSCk1K`. Settlements: `5FffySLMGViJLqi3yJw6MTyF86wmbpwb6zFv9rFNjDUoMpcuhCbqUF5tpm3g1fx5nT2KPnSELio4Y9XqFi6iuJew`, `62e7BqRi7LtCr1iTqTGpnuRWg43VYe5LGScybkYVK4PnPisNubqAgwCV1huKZk3kDvhWKZ4JiMXWEvuqS5mgHLeD`, `3xyXxwjRaayZULnJxoVdPMPBDG1MGEpKkMX3dEvTwRj7Majw9zpTAmkAcz7zdfr1kZ4a6DBooZgrhemHgHQJxko4`.
  - **How the prices were set.** In both books one price traded more shares than any other, so volume alone set it. Neither the Pyth tie-break nor the midpoint rule played any part. AAPLx cleared at $336.97. Pyth's mainnet AAPL/USD price, published three seconds before the cross, was $336.85534, 0.03% away. That is not blind discovery: participants could see the Pyth reference in the app, where it is the first suggested price in the order form. The book set the price, and it agreed closely with the reference.
  - **What each order got.** Nobody paid above their limit or sold below it. In AAPLx, the best fills for the 10 non-bot wallets were $2.63 a share under a buy limit and $3.10 over a sell limit. In IBMx, one buyer paid $3.96 a share under its limit, and every other non-bot IBMx fill was at its own limit.
...
- **Dashboard:** one candle per auction, a depth ladder, order entry, and every auction linked to its transactions. The top of each ticker separates what the book computes (the price it would clear at, the shares that would trade, best bid and ask, time to the cross) from the one external number, Pyth, with its age and what the program's own check made of it. Every auction has its own page, which replays the clearing rule from the auction account and checks the result against the price the program recorded, and any wallet's receipts and orders can be shared as a read-only link. Documentation, with a script to recompute any clearing price from chain: https://docs.uncross.0xo.in
...
- **Participation is small, and it is not bot-free.** Two auctions have had people besides us in them: the 23 September MSTRx cross (two people from a group chat) and the 24 September community auction (11 non-bot wallets, with the bot's own orders in the same books). None of this is evidence of organic market demand.
- Outside the 23 and 24 September events, devnet orders come from our test bot, priced around Pyth or around Jupiter where no feed exists, and from our own test wallets. On those books a clearing price near the reference shows the bot followed its instructions, not independent discovery.
...
- **Found and fixed on 24 Sept: the refund path could void a cross.** `cancel_and_refund` returns every order's full escrow. It is meant for when normal settlement cannot run, such as when an issuer pauses the mint. It had no caller check and did not require a paused mint, so whoever sent the first settlement batch after a cross could choose it and undo every trade. Nothing could be stolen: every order would have got back exactly what it locked. It is now allowed only when the ticker mint is paused, or once an earlier batch has already taken the refund path, which is how a seller's shares come back after an issuer resumes. The upgrade is `3aE7J9JCgKadPp9Eqgo49oen7m9P6mgqhdvjHAZUATAKoeFcVNcu96kQUon9juRVufbbXa9pxdodHsVMLC42YEKY`. On devnet the paused-mint refund still returns every balance, and a stranger, a participant, and attempts mid-window and after partial settlement are all refused on chain. Every signature is in `docs/phase2.md`.
...
▲ **25 Sept, last pass.** The community auction is now the first item in "What's built", every figure read from chain: both auction accounts, every order account checked against the bot's 42 wallets, each new wallet's first transaction, and the mainnet Pyth price at the AAPLx cross, decoded from the update transaction's signed price message. The bot's share is in the same paragraph. The prices are described as set by volume, agreeing with a reference participants could see, not as independent discovery. Two figures differ from the brief. The nine new wallets appeared within 15 minutes of the AAPLx cross, not 12 (the earliest, at 12:47:22 UTC, was 14.7 minutes before it). And $2.63 and $3.10 are AAPLx's best non-bot fills: in IBMx one buyer did better, $3.96 under its limit, so the text gives both books. The "Most devnet orders" line now says what is true outside the two events. The Dashboard item adds the auction page, read-only links and the docs site, all live since 25 Sept.

▲ **24 Sept evening.** Added the community auction's results, read from chain with `scripts/event-report.mjs`. None of the 11 outside wallets is one of the bot's 42. The event sequence was not run, so the bot was in both books and the text says so. The rent-recovery figure is now the exact 2.199437 SOL from 120 closes. Added the `cancel_and_refund` finding from the docs pass. It is fixed and tested on devnet the same day, so it now reads as found and fixed, with its signatures.
...
▲ **Superseded on 25 Sept:** "No public auction with outside participants has happened yet." It was true when added. The 24 Sept community auction, announced publicly, had 11 wallets besides the test bot, and the text now says so.
