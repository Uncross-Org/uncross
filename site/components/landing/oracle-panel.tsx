      ...
      {oracle ? (
        <>
          ...
          <p className="max-w-[52ch] text-[12.5px] leading-relaxed text-muted">
            Checked every five minutes for 10h38m, straight through the 4pm close and deep into the overnight: at all
            80 checks the latest print was at most 14 seconds old. Its schedule called the market closed the whole
            time. The account carries no session field, so on-chain a thin after-hours print and a
