...
export function AnimatedBeamPathIllustration({
  ...
  return (
    <div className="flex h-full w-full shrink-0 items-center justify-center overflow-visible [--beam-color-1:var(--accent)] [--beam-color-2:var(--accent)] [--beam-color-3:var(--accent)] [--path-color:var(--line)] dark:[--beam-color-1:var(--accent)] dark:[--beam-color-2:var(--accent)] dark:[--beam-color-3:var(--accent)] dark:[--path-color:var(--line)]">
      <svg
